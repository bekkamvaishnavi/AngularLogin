...
angular.module('angular-login.mock', ['ngMockE2E'])
    ...
    .run(function ($httpBackend, $log, loginExampleData) {
        ...
        if (userStorage === null || emailStorage === null) {
            userStorage = {
                'nagender': { name: 'Nagender', username: 'nagender', password: 'hello', email: 'nagender.peddi@gmail.com', userRole: userRoles.user, tokens: [] },
                'sampleu': { name: 'SampleUser', username: 'sampleu', password: 'world', email: 'sample.user@gmail.com', userRole: userRoles.admin, tokens: [] }
            };
            emailStorage = {
                'nagender.peddi@gmail.com': 'nagender',
                'sample.user@gmail.com': 'sampleu'
            };
